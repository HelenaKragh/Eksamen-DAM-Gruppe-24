...
```{r}
Koordinater <- readxl::read_excel (here("data_fælles","Sogn_Koordinater_sidste-kopi.xlsx"))
...
library(leaflet)
library(readxl)
Sogn_Koordinater_sidste <- read_excel("data_fælles/Sogn_Koordinater_sidste-kopi.xlsx", 
