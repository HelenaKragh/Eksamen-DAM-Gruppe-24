...
ggplot(aarhus_data,aes(sogn))+
  ...
  theme(axis.text = element_text(angle = -90))+
   labs(title = "Fordeling af respondenter på tværs af sogn")
```



Vi vil gerne kigge bl.a. på alderen, cvilstanden og den geografiske placering for  forskellige erhverv af fattige:
Tyende, Syg og vanfør, Bonde uden jord, Tiggere, Almissemodtager, Aftægtsfolk/pensioneret og Uden erhverv
...
ggplot(Tyende_data,aes(alder))+
  geom_bar()+
  theme(axis.text = element_text(angle = -90))+
   labs(title = "Tyendes fordeling i alder")

#Geografisk placering og køn
ggplot(Tyende_data,aes(sogn))+
  geom_bar()+
  theme(axis.text = element_text(angle = -90))+
   labs(title = "Tyendes fordeling i sogn")
...
ggplot(Sygogvanfør_data,aes(alder))+
  geom_bar()+
  theme(axis.text = element_text(angle = -90))+
   labs(title = "Syge og vanføres fordeling i alder")
...
ggplot(Bonde_u_jord,aes(alder))+
  geom_bar()+
theme(axis.text = element_text(angle = -90))+
  labs(title = "Bønder uden jords fordeling i alder")
...
ggplot(Almissemodtager_data,aes(alder))+
  geom_bar()+
  theme(axis.text = element_text(angle = -90))+
  labs(title = "Almissemodtageres fordeling i alder")
...
ggplot(Aftægt_data,aes(alder))+
  geom_bar()+
  theme(axis.text = element_text(angle = -90))+
  labs(title = "Aftægtsfolk/pensioneredes fordeling i alder")

#Geografisk placering
ggplot(Aftægt_data,aes(sogn))+
  geom_bar()+
  theme(axis.text = element_text(angle = -90))+
  labs(title = "Aftægtsfolk/pensioneredes fordeling i sogn")
```
...
ggplot(Uden_erhverv_data,aes(sogn))+
  geom_bar()+
theme(axis.text = element_text(angle = -90))+
  labs(title = "Arbejdsløses fordeling i sogn")
