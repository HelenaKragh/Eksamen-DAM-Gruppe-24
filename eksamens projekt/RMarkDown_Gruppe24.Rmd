...
Vi kigger også på at par andre af erhvervskategorierne:
Syge og vanføre: Her er det også interessant at kigge på "erhverv," for at sammenligne de to grupper "vanvittig" og "hospitalsem", som falder ind under overkaterogiseringen:
...
ggplot(Uden_erhverv_data,aes(alder))+
  geom_bar(aes(fill = erhverv))+
  labs(title = "Arbejdsløses fordeling i alder og erhverv",y="Antal arbejdsløse")

#Geografisk placering 
ggplot(Uden_erhverv_data,aes(sogn))+
  geom_bar()+
theme(axis.text = element_text(angle = -90))+
  labs(title = "Arbejdsløses fordeling i sogn",y="Antal arbejdsløse")
