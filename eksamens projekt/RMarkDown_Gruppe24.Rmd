...
erhverv %in% c("Hospitalslem", "Vanvittig","Vanfør") ~ "Syge og vanføre",
...
for (i in 2:nrow(aarhus_data)) {
  if(aarhus_data$famstand[i] == "Hans Kone" && aarhus_data$Erhvervskategori[i-1]== "Bonde med jord"){
...
```{r}
for (i in 2:nrow(aarhus_data)) {
  if(aarhus_data$famstand[i] == "Hans Kone" && aarhus_data$Erhvervskategori[i-1]== "Bonde uden jord"){
  aarhus_data$Erhvervskategori[i]<- 
    paste(aarhus_data$Erhvervskategori[i-1])
  }
  }
...
ggplot(count_data,aes(x=Erhvervskategori,y = percentage))+
  ...
  labs(y="Procent",title = "Erhvervskategori i procent")


```

Vi vil gerne kigge bl.a. på alderen, cvilstanden og den geografiske placering for de forskellige erhverv af fattige:
...
Vi starter med at lave et nyt dataset, hvor vi isolerer erhvervskategorien "Tyende" fra aarhus_data. Derefter laver vi to søjlediagrammer for de tyende fra datasættet. Den første viser fordelingen i tyendes alder samt deres civilstand og den anden viser de tyendes geografiske placering samt kønsfordelingen.
...
ggplot(Tyende_data,aes(alder))+
  ...
  theme(axis.text = element_text(angle = -90))+
   labs(title = "Tyendes fordeling i alder og civilstand")

#Geografisk placering og køn
ggplot(Tyende_data,aes(sogn))+
  geom_bar(aes(fill = koen))+
  theme(axis.text = element_text(angle = -90))+
   labs(title = "Tyendes fordeling i sogn og køn")
    
```


Vi gør det samme med Syge og vanføre. Her er det også interessant at kigge på "erhverv," for at sammenligne de to grupper "vanvittig" og "hospitalsem", som falder ind under overkaterogiseringen:
...
ggplot(Sygeogvanføre_data,aes(alder))+
  geom_bar(aes(fill = civilstand))+
  theme(axis.text = element_text(angle = -90))+
   labs(title = "Syge og vanføres fordeling i alder og civilstand")
#Geografisk placering og erhverv
ggplot(Sygeogvanføre_data,aes(sogn))+
  geom_bar(aes(fill = erhverv))+
  theme(axis.text = element_text(angle = -90))+
  labs(title = "Syge og vanføres fordeling i sogn og erhverv")
```
...
ggplot(Bonde_u_jord,aes(alder))+
  geom_bar(aes(fill = civilstand))+
theme(axis.text = element_text(angle = -90))+
  labs(title = "Bønder uden jords fordeling i alder og civilstand")
#Geografisk placering
ggplot(Bonde_u_jord,aes(sogn))+
  geom_bar()+
  theme(axis.text = element_text(angle = -90))+
  labs(title = "Bønder uden jords fordeling i sogn")
...
ggplot(Tigger_data,aes(alder))+
  geom_bar(aes(fill = civilstand))+
  labs(title = "Tiggeres fordeling i alder og civilstand")
#Geografisk placering
ggplot(Tigger_data,aes(sogn))+
  geom_bar(aes(fill = koen))+
  labs(title = "Tiggeres fordeling i sogn og køn")
```
...
ggplot(Almissemodtager_data,aes(alder))+
  geom_bar(aes(fill = civilstand))+
  theme(axis.text = element_text(angle = -90))+
  labs(title = "Almissemodtageres fordeling i alder og civilstand")

#Alder og Køn
ggplot(Almissemodtager_data,aes(alder))+
  geom_bar(aes(fill = koen))+
  theme(axis.text = element_text(angle = -90))+
  labs(title = "Almissemodtageres fordeling i alder og køn")

#Geografisk placering
ggplot(Almissemodtager_data,aes(sogn))+
  geom_bar()+
  theme(axis.text = element_text(angle = -90))+
  labs(title = "Almissemodtageres fordeling i sogn")
```

Aftægtsfolk/pensionerede: Her laver vi også et diagram med alder og køn
...
ggplot(Aftægt_data,aes(alder))+
  geom_bar(aes(fill = civilstand))+
  theme(axis.text = element_text(angle = -90))+
  labs(title = "Aftægtsfolk/pensioneredes fordeling i alder og civilstand")
#Alder og køn
ggplot(Aftægt_data,aes(alder))+
  geom_bar(aes(fill = koen))+
  theme(axis.text = element_text(angle = -90))+
  labs(title = "Aftægtsfolk/pensioneredes fordeling i alder og køn")
#Geografisk placering og erhverv
ggplot(Aftægt_data,aes(sogn))+
  geom_bar(aes(fill = erhverv))+
  theme(axis.text = element_text(angle = -90))+
  labs(title = "Aftægtsfolk/pensioneredes fordeling i sogn og erhverv")
...
ggplot(Uden_erhverv_data,aes(alder))+
  geom_bar(aes(fill = erhverv))+
  labs(title = "Arbejdsløses fordeling i alder og erhverv")
#Alder og køn
ggplot(Uden_erhverv_data,aes(alder))+
  geom_bar(aes(fill = koen))+
  theme(axis.text = element_text(angle = -90))+
  labs(title = "Arbejdsløses fordeling i alder og koen")
#Geografisk placering og civilstand
ggplot(Uden_erhverv_data,aes(sogn))+
  geom_bar(aes(fill = civilstand))+
theme(axis.text = element_text(angle = -90))+
  labs(title = "Arbejdsløses fordeling i sogn og civilstand")

```

Ufaglærte arbejdere: også med et digram med alder og køn
...
ggplot(Ufaglært_arbejder_data,aes(alder))+
  geom_bar(aes(fill=civilstand))+
  theme(axis.text = element_text(angle = -90))+
  labs(title = "Ufaglærtes fordeling i alder og civilstand")
#Alder og køn
ggplot(Ufaglært_arbejder_data,aes(alder))+
  geom_bar(aes(fill = koen))+
  theme(axis.text = element_text(angle = -90))+
  labs(title = "Ufaglærtes fordeling i alder og køn")
#Geografisk placering
ggplot(Ufaglært_arbejder_data,aes(sogn))+
  geom_bar()+
  theme(axis.text = element_text(angle = -90))+
  labs(title = "Ufaglærtes fordeling i sogn")
```
...
ggplot(Svend_lære_data,aes(alder))+
  geom_bar(aes(fill = civilstand))+
  labs(title = "Svend eller i læres fordeling i alder og civilstand")
#Geografisk placering
ggplot(Svend_lære_data,aes(sogn))+
  geom_bar()+
  theme(axis.text = element_text(angle = -90))+
  labs(title = "Svend eller i læres fordeling i sogn")
```
